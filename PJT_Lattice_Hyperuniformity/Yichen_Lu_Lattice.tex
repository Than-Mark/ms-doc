...
\begin{figure}[H]
    ...
    \caption{
        (a) Structure factor $S(\mathbf{q})$ for varying coupling strength $K$ at fixed frustration $\alpha=0.6\pi$. (b) Density fluctuation variance $\left< \delta \rho ^2 \right>$ as a function of mean density $\left< \rho \right>$ for different $K$ values.
    }
\end{figure}
