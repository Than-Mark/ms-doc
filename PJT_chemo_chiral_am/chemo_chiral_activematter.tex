...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/bigGraphParticle_o0_sP0.01.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/bigGraphParticle_o0_sP0.1.png}
    \caption{
...
% \includepdf[pages={9}, width=0.9\textwidth]{figs/snapshots_o0_sP0.01.pdf}
% \subsection{Time Varying Snapshots of Particle Distributions}
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=\textwidth]{figs/snapshots_o0_sP0.01.png}
%     % \caption{
%     %     Time varying snapshots of the particle distribution of the chemotactic model with Lotka-Volterra functions in Eqs.~\eqref{eq:chemoLVModel}. The parameters used are: $\omega=0$, $D_1=D_2=1$, $v=0.01$. The time step is 0.01 and the total time is 10.
%     % }
% \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/bigGraphField_o0_sP0.01.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/bigGraphField_o0_sP0.1.png}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{partials}[0.41\linewidth]{
      \includegraphics[width=\linewidth]{figs/particle.png}
    }
    \hfill
    \subcaptionbox{chemical fields}[0.55\linewidth]{
      \includegraphics[width=\linewidth]{figs/streamplot.png}
    }
    % \caption{
    %     \textbf{(a)} 1D particle simulation of the chemotactic model with Lotka-Volterra functions. \textbf{(b)} Streamplot of the chemical fields $c_1$ and $c_2$ in the 2D simulation. The color indicates the value of the chemical field, while the arrows indicate the direction of the flow. The length of the arrows is proportional to the magnitude of the flow. The color bar on the right shows the range of values for $c_1$ and $c_2$. The parameters used are: $k_1=0.5$, $k_2=0.5$, $k_3=0.5$, $k_4=0.5$, $\omega=0.5$, $D_1=0.5$, $D_2=0.5$.
    % }
\end{figure}
