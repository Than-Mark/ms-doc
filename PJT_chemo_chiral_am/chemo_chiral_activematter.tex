...
\begin{subequations}
    \begin{align}
        &\dot{\mathbf{r}}_{i}^{1,2}=v\mathbf{p}\left( \theta _{i}^{1,2} \right) -\sum_{s\in \left\{ 1,2 \right\}}{\sum_{j=1}^N{\frac{H\left( r_c - \left| \mathbf{r}_{j}^{s}-\mathbf{r}_{i}^{1,2} \right| \right)}{\left| \mathbf{r}_{j}^{s}-\mathbf{r}_{i}^{1,2} \right|^{\beta}}}}\;,\\
        &\dot{\theta}_{i}^{1,2}=\alpha _{1,2}\mathbf{p}\left( \theta _{i}^{1,2} \right) \times \nabla c_{1,2}\;,\\
