...
When $K=0$, the swarmalators are uncoupled and the system is reduced to the chemotactic dynamics.
% \begin{itemize}
...
\begin{equation}
    \hat{\varrho}_k(\mathbf{r},t)=\int_{-\pi}^\pi\mathrm{d}\theta \varrho(\mathbf{r},\theta,t) \mathrm{e}^{\mathrm{i}k\theta}.
\end{equation}
The inverse Fourier transform is
\begin{equation}
    \varrho(\mathbf{r},\theta,\omega,t)=\cfrac{1}{2\pi}\sum_{k=-\infty}^{\infty}{\hat{\varrho}_k(\mathbf{r},\omega,t)\mathrm{e}^{\textrm{i}k\theta}}\;.
\end{equation}
In this framework, the uniform distribution $\varrho _0(\mathbf{r},\theta ,\omega ,t)=\left( 2\pi \right) ^{-1}\varrho _{0}^{*}$ corresponds to $\hat{\varrho}_k(\mathbf{r},\omega,t)=\left( 2\pi \right) ^{-1}\varrho _{0}^{*}\delta_{k,0}$.
