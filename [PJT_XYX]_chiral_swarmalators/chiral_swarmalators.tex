...
\end{equation}
For the case of the phase coupling dynamics, the equation for the density $\rho$ is
\begin{equation}
    \begin{aligned}
        ...
        &-G\frac{\partial}{\partial \theta}\rho \left( \mathbf{r},\theta ,\omega ,t \right) \int{\text{d}\mathbf{r}'\text{d}\theta '\text{d}\omega '\rho \left( \mathbf{r}',\theta ',\omega ',t \right) \sin \left( \theta '-\theta \right) \delta \left( \mathbf{r}'-\mathbf{r} \right)}\\
    \end{aligned}
\end{equation}
