...
Consider a chemical field $c\left( \mathbf{r},t \right)$ that is produced by the ensemble of ‘signalling’ rotors. Swarmalators interact with the chemical field and move towards the regions with higher concentration, which can be described by the following equation:
\begin{equation}
