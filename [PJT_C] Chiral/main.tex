...
\begin{figure}
    ...
    \caption{
        \label{fig:adiabaticTuning} The adiabatic tuning of the action radius. 
        \textbf{(a)}, The action radius $r_s$ of the clusters in the Swarm state with different $\lambda$ and $d_0$. 
        \textbf{(b)}, The action radius $r_s$ of the clusters in the Swarm state with different $\lambda$ and $d_0$ in the adiabatic tuning. 
    }
\end{figure}
