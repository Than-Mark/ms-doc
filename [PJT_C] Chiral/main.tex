...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{(a)},\textbf{(b)}, horizontal and vertical coordinate of centers' positions. As time goes on, the centers of oscillators with the same chirality converge.
    }
\end{figure}
...
The oscillators' phase is uniformly distributed in the range $\left[ -\pi,\pi \right]$, as shown in Fig.~\ref{fig:phaseHist}a. 
...
Having described the five states of our system,
we next discuss how to distinguish them.
