...
% due to the fact that the oscillators only couples when the spatial distance is less than d, and the d0 of the ring state is small, the absolute value of A is very small
