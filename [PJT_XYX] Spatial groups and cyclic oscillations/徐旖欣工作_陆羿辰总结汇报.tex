...
\vspace{-0.1cm}
$$
\lambda _{c2}=\frac{\Delta \bar{\omega}}{\sum_{j=1}^{N_c}{A_{ij}}}=\frac{\bar{\omega}_{\max}-\bar{\omega}_{\min}}{2\frac{N_c\pi d_{0}^{2}}{L^2}}=\frac{L^2\left( \bar{\omega}_{\max}-\bar{\omega}_{\min} \right)}{2N_c\pi d_{0}^{2}}
$$
