...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{./figs/lattice_constant_vs_kstar.pdf}
%     \caption{
%         Mean lattice constant $a$ versus the critical wave number $k^*$ (defined as the first local maximum point of $\mathrm{Re}[ \lambda _{m}^{\left[ 0 \right]}\left( k \right) ]$).
%     }
% \end{figure}
...
\begin{figure}[H]
    ...
    \hfill
    \subcaptionbox{
        Mean lattice constant $a$ versus the period of zero point, $T^*$.
    }[0.49\linewidth]{
